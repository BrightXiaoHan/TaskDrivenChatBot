...
用户输入节点
"""
from xiaoyu.dialogue.nodes.base import _BaseNode, callback_cycle_checker
...
class UserInputNode(_BaseNode):
    ...
    optional_checkers = dict(life_cycle=callback_cycle_checker(), callback_words=callback_cycle_checker())
